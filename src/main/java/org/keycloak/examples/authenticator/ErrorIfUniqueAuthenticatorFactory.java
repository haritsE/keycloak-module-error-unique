 ...
 */
public class ErrorIfUniqueAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "error-if-unique";
    static ErrorIfUniqueAuthenticator SINGLETON = new ErrorIfUniqueAuthenticator();
